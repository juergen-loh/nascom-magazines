...
function externalLink($link, $text="", $delimiter="\n", $title="")
{
	...
	case "80-Bus News":				$url = "/nascom/magazines/80-bus-news/";										break;
	...
	case "Apple&nbsp;II":			$url = "https://en.wikipedia.org/wiki/Apple_II";								break;
	...
	case "INMC 80 News 1, page 15":	$url = "/nascom/magazines/inmc-80-news/01/15/text/#article1";					break;
	case "INMC 80 News 5, page 50":	$url = "/nascom/magazines/inmc-80-news/05/50/text/#article1";					break;
	case "INMC 80 News":			$url = "/nascom/magazines/inmc-80-news/";										break;
	case "INMC News 3, page 24":	$url = "/nascom/magazines/inmc-news/03/24/text/#article1";						break;
	case "INMC News 5, page 29":	$url = "/nascom/magazines/inmc-news/05/29/text/#article1";						break;
	case "INMC News 6, page 33":	$url = "/nascom/magazines/inmc-news/06/33/text/#article1";						break;
	case "INMC News 7":				$url = "/nascom/magazines/inmc-news/07/";										break;
	case "INMC News 7, page 18":	$url = "/nascom/magazines/inmc-news/07/18/text/#article1";						break;
	case "INMC News":				$url = "/nascom/magazines/inmc-news/";											break;
	...
	case "mc";						$url = "https://de.wikipedia.org/wiki/Mc_%28Zeitschrift%29";					break;	case "mc 1/1987":				$url = "https://www.kultboy.com/index.php?site=kult/kultmags&km=show&id=9523";	break;
	...
	case "Micropower":				$url = "/nascom/magazines/micropower/";											break;
	...
	case "Nascom 1":				$url = "/nascom/1/";															break;
	...
	case "PICO Computer":			$url = "/pico/";																break;
	...
	case "Z80-KIT":					$url = "/z80-kit/";																break;
