...
function echoShy($str)
{
	...
	foreach ($arr as $value) {
		...
		case "DEBUG-Verschiebungsvektor":		$erg = "DEBUG-Verschiebungs&shy;vektor";					break;
		...
		case "NASPEN-Textverarbeitungssystems":	$erg = "NASPEN-Text&shy;verarbeitungs&shy;systems";			break;
		...
		case "Speichererweiterungen":			$erg = "Speicher&shy;erweiterungen";						break;
		...
		case "Verschiebungsvektor":				$erg = "Verschiebungs&shy;vektor";							break;
		...
		case "ZEAP-Verschiebungsvektor":		$erg = "ZEAP-Verschiebungs&shy;vektor";						break;
